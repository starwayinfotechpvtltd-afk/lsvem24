                                    ...
                                    child: Container(
                                      ...
                                      child: Stack(
                                        ...
                                        children: [
                                          ...
                                          // if (controller.activeOverlayAd !=
                                          //     null)
                                          //   LongVideoAdCornerOverlay(
                                          //     ad: controller.activeOverlayAd!,
                                          //     onClose:
                                          //         controller.dismissOverlayAd,
                                          //   ),
                                          ...
                                          Positioned(
                                            ...
                                            child: Visibility(
                                              visible:
                                                  AppStrings.isShowWaterMark,
                                              child: CachedNetworkImage(
                                                imageUrl:
                                                    AppStrings.waterMarkIcon,
                                                fit: BoxFit.contain,
                                                imageBuilder:
                                                                        ...
                                                                        await CustomShare
                                                                          ...
                                                                          url: (details?.videoUrl?.isNotEmpty ?? false)
                                                                              ...
                                                                              : controller.mainWatchedVideos.isNotEmpty
                                                                                  ? controller.mainWatchedVideos[controller.selectedWatchedVideo].videoUrl
                                                                                  : "",
                                                                          channelId:
                                                                              details?.channelId ?? "",
                                                                          videoId:
                                                                                    ...
                                                                                    GestureDetector(
                                                                                      ...
                                                                                      child: Row(
                                                                                        children: [
                                                                                          ...
                                                                                          Obx(
                                                                                            () => Text(
                                                                                              controller.currentSpeedIndex.value == 2 ? AppStrings.normal.tr : "${controller.speedOptions[controller.currentSpeedIndex.value]}x",
                                                                                              style: GoogleFonts.urbanist(
                                                                                                textStyle: const TextStyle(
                                                                                                  fontWeight: FontWeight.bold,
                                                                                                  fontSize: 15,
                                                                                  ...
                                                                                  GestureDetector(
                                                                                    ...
                                                                                    child: Row(
                                                                                      children: [
                                                                                        ...
                                                                                        const SizedBox(width: 10),
                                                                                        Text(AppStrings.playbackSpeed.tr, style: GoogleFonts.urbanist(textStyle: const TextStyle(fontWeight: FontWeight.bold, fontSize: 15))),
                                                                                        const Spacer(),
                                                                                        Obx(
                                                                                          () => Text(
                                                                                            controller.currentSpeedIndex.value == 2 ? AppStrings.normal.tr : "${controller.speedOptions[controller.currentSpeedIndex.value]}x",
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Positioned
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        painter:
                                                                            AdMarkersPainter(
                                                                          adTimings:
                                                                              controller.adTimings,
                                                                          videoDuration:
                                                                              controller.videoPlayerController?.value.duration ?? Duration.zero,
                                                                          adShowCount:
                                                                              controller.adShowCount,
                                                                          currentPosition: controller.videoPlayerController != null
                                                                    ...
                                                                    SliderTheme(
                                                                      ...
                                                                      child:
                                                                          Slider(
                                                                        value:
                                                                            controller.videoPlayerController?.value.position.inMilliseconds.toDouble() ??
                                                                                0,
                                                                        onChanged:
                                                                            (double
                                                                                value) {
                                                                          ...
                                                                          Duration? currentPosition = controller
                                                                              .videoPlayerController
                                                                              ?.value
                                                                              .position;
                                                                          Duration
                                                                        ...
                                                                        min:
                                                                            0.0,
                                                                        max: controller.videoPlayerController?.value.duration.inMilliseconds.toDouble() ??
                                                                            0,
                                                                      ),
                                                                    ),
                                                                  ],
                                                              ...
                                                              children: [
                                                                ...
                                                                Obx(
                                                                  () =>
                                                                      IconButton(
                                                                    icon: ImageIcon(
                                                                        const AssetImage(AppIcons
                                                                            .previous),
                                                                        size:
                                                                            25,
                                                                        color: controller.isDisablePrevious.value
                                                                ...
                                                                Obx(
                                                                  () =>
                                                                    ...
                                                                    icon: ImageIcon(
                                                                        ...
                                                                        size:
                                                                            25,
                                                                        color: controller.isDisableNext.value
                                                                            ? AppColor.white.withOpacity(0.6)
                                                                            : AppColor.white),
                                                                    onPressed: controller
                                                                            .isDisableNext
                                                                  ...
                                                                  children: [
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          if (!controller
                                                                            ...
                                                                            controller.isLike.value =
                                                                                true;
                                                                            controller.customChanges["like"]++;
                                                                            await LikeDisLikeVideoApi.callApi(controller.videoId,
                                                                                true);
                                                                          }
                                                                        },
                                                                        icon:
                                                                            ImageIcon(
                                                                          AssetImage(controller.isLike.value
                                                                              ? AppIcons.likeBold
                                                                              : AppIcons.like),
                                                                          size:
                                                                              25,
                                                                    ...
                                                                    Obx(
                                                                      () =>
                                                                        ...
                                                                        icon: ImageIcon(AssetImage(controller.isDisLike.value ? AppIcons.disLikeBold : AppIcons.disLike),
                                                                                size: 25,
                                                                                color: AppColor.white)
                                                                            .paddingOnly(top: 2),
                                                                      ),
                                                                ...
                                                                Row(
                                                                  children: [
                                                                    IconButton(
                                                                      ...
                                                                      onPressed:
                                                                          () async =>
                                                                              await controller.backwardSkipVideo(),
                                                                    ),
                                                                    const SizedBox(
                                                                        width:
                                                                            10),
                                                                    ...
                                                                    IconButton(
                                                                      ...
                                                                      onPressed:
                                                                          () async =>
                                                                              await controller.forwardSkipVideo(),
                                                                    ),
                                                                  ],
                                                                ),
                                                                Row(
                                                                  children: [
                                                                    IconButton(
                                                                      ...
                                                                      icon: Obx(
                                                                        () => ImageIcon(
                                                                            AssetImage(controller.isSave.value
                                                                                ? AppIcons.saveDone1
                                                                                : AppIcons.addToSave),
                                                                            size: 22,
                                                                            color: AppColor.white),
                            ...
                            children: [
                              if ((controller.videoDetailsModel?.detailsOfVideo
                                ...
                                PreviewVideoImage(
                                  ...
                                  videoImage: controller.videoDetailsModel!
                                          .detailsOfVideo!.videoImage ??
                                      '',
                                  fit: BoxFit.cover,
                                ),
                              Positioned(
                ...
                children: [
                  ...
                  Obx(() => controller.isDownloading.value
                      ...
                      : NormalVideoDetailsIconUi(
                          title: AppStrings.download.tr,
                          icon: DownloadHistory.mainDownloadHistory.any(
                                  (map) => map['videoId'] == controller.videoId)
                              ? AppIcons.accept
                              : AppIcons.videoDownload,
                          callback: () async {
                            if (DownloadHistory.mainDownloadHistory.any((map) =>
                                map['videoId'] == controller.videoId)) {
                              CustomToast.show("Video Already Downloaded");
                            } else if ((GetProfileApi
                                    .profileModel?.user?.isPremiumPlan ??
                              ...
                              if (downloadPath != null) {
                                ...
                                if (downloadThumbnail != null) {
                                  ...
                                  DownloadHistory.mainDownloadHistory.insert(
                                    0,
                                    {
                                      "videoId": controller.videoDetailsModel
                                              ?.detailsOfVideo?.id ??
                                          "",
                                      "videoTitle": controller.videoDetailsModel
                                              ?.detailsOfVideo?.title ??
                                          "",
                                      "videoType": controller.videoDetailsModel
                                              ?.detailsOfVideo?.videoType ??
                                          0,
                                      "videoTime": controller.videoDetailsModel
                                              ?.detailsOfVideo?.videoTime ??
                                          0,
                                      "videoUrl": downloadPath,
                                      "videoImage": downloadThumbnail,
                                      "views": controller.videoDetailsModel
                                              ?.detailsOfVideo?.views ??
                                          0,
                                      "channelId": controller.videoDetailsModel
                                              ?.detailsOfVideo?.channelId ??
                                          "",
                                      "channelName": controller
                                              .videoDetailsModel
                      ...
                      ? GestureDetector(
                          onTap: () async {
                            ...
                            if (controller.isSubscribe.value == false) {
                              ...
                              final oldSubscribe = controller.isSubscribe.value;
                              ...
                              if (!success) {
                                controller.isSubscribe.value = oldSubscribe;
                      ...
                      : GestureDetector(
                          onTap: () async {
                            ...
                            if (!success) {
                              ...
                              controller.customChanges["subscribe"] = oldCount;
                            }
                          },
                          child: Obx(
                            () => Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      icon:
                          const ImageIcon(AssetImage(AppIcons.swap), size: 20),
                    ),
                  ],
                ),
              ),
