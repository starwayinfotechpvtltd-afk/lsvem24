              ...
              bottomNavigationBar: Padding(
                ...
                child: CustomFilledButton(
                    ...
                    callback: () {
                      ...
                      // Show snackbar after Home is loaded
                      CustomToast.show('Video is Uploading, Please Wait ...');
                    }),
              ),
              appBar: AppBar(
                elevation: 0,
                    ...
                    children: [
                      ...
                      GetBuilder<UploadVideoController>(
                        ...
                        builder: (controller) => InsertDataView(
                          ...
                          subTitle:
                              controller.videoDescriptionController.text.trim(),
                          callback: () {
                            controller.onStopVideoPlay();
                      ...
                      Obx(
                        () => InsertDataView(
                          ...
                          subTitle: visibilityCollection[
                              controller.selectVisibility.value]["title"],
                          callback: () {
                            controller.onStopVideoPlay();
                      ...
                      Obx(
                        () => InsertDataView(
                          ...
                          subTitle: audienceCollection[
                              controller.selectAudience.value],
                          callback: () {
                            controller.onStopVideoPlay();
                      ...
                      Obx(
                        () => InsertDataView(
                          ...
                          subTitle: commentCollection[
                              controller.selectComments.value],
                          callback: () {
                            controller.onStopVideoPlay();
